...
namespace ArenaHub.API.Services
{
    public interface ITournamentService
    {
        ...
        Task<TournamentDto?> UpdateAsync(Guid id, UpdateTournamentRequestDto request, string currentUserId);
        Task<TournamentDto?> DeleteAsync(Guid id, string currentUserId);
    }
}
